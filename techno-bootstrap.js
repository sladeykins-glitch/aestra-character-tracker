...
// Music binds before the rest of this follow-up chain so login, opening and
// normal tracker interactions can all unlock playback reliably.
await load('./ambient-music.js?v=4');
...
await load('./completion-sweep.js?v=22');
