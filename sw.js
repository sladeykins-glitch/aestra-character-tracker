const CACHE='aestra-v125-mobile';
const SHELL=['./','./index.html','./styles.css?v=5','./aestra-icon.svg','./manifest.webmanifest','./version.json','./hero-console-v2.js?v=1','./compact-header.js?v=2'];
