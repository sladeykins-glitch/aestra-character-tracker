const CACHE='aestra-v146-reliable-music';
const SHELL=['./','./index.html','./styles.css?v=5','./aestra-icon.svg','./manifest.webmanifest','./version.json','./app.js?v=79','./techno-bootstrap.js?v=4','./hero-console-v2.js?v=1','./compact-header.js?v=2','./performance-lite.js?v=2','./skill-levels.js?v=3','./character-creation-v2-identity-fix.js?v=2','./completion-sweep.js?v=22','./opening-cinematic.js?v=4','./opening-cinematic-interaction-fix.js?v=1','./ambient-music.js?v=4','./build-remove-controls-final.js?v=2','./unified-build-library-v3.js?v=1','./build-library-startup-guard.js?v=1','./class-skill-level-sync.js?v=1','./level-up-v2.js?v=1','./inventory-navigation-v2.js?v=1','./picker-navigation-fix.js?v=1','./pwa-register.js?v=20'];
