const CACHE='aestra-v138-stable-remove-controls';
const SHELL=['./','./index.html','./styles.css?v=5','./aestra-icon.svg','./manifest.webmanifest','./version.json','./app.js?v=79','./hero-console-v2.js?v=1','./compact-header.js?v=2','./performance-lite.js?v=2','./character-creation-v2-identity-fix.js?v=2','./completion-sweep.js?v=14','./opening-cinematic.js?v=4','./opening-cinematic-interaction-fix.js?v=1','./ambient-music.js?v=1','./build-remove-controls-final.js?v=2','./pwa-register.js?v=13'];
