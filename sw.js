const CACHE='aestra-v154-core-skill-choices';
const SHELL=['./','./index.html','./styles.css?v=5','./aestra-icon.svg','./manifest.webmanifest','./version.json','./app.js?v=83','./techno-bootstrap.js?v=6','./hero-console-v2.js?v=1','./compact-header.js?v=2','./performance-lite.js?v=2','./skill-levels.js?v=4','./character-creation-v2-identity-fix.js?v=3','./completion-sweep.js?v=27','./opening-cinematic.js?v=4','./opening-cinematic-interaction-fix.js?v=1','./ambient-music.js?v=5','./equipment-purchase.js?v=1','./build-picker-normalize.js?v=2','./build-remove-controls-final.js?v=4','./unified-build-library-v3.js?v=3','./class-skill-level-sync.js?v=1','./core-skill-choice-tools.js?v=1','./level-up-v2.js?v=1','./inventory-navigation-v2.js?v=2','./pwa-register.js?v=27'];
