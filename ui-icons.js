...
const paths={
  classes:'M12 2 5 6v5c0 4.6 2.8 8.8 7 11 4.2-2.2 7-6.4 7-11V6l-7-4Zm0 4 3.5 2-1.2 4H9.7L8.5 8 12 6Zm-2.2 8h4.4L12 18l-2.2-4Z',
  skills:'M13 2 5 14h6l-1 8 9-13h-6V2Z',
  abilities:'M12 2l2.2 6.1L20 6l-2.7 5.5L22 15l-6.4.3L16 22l-4-5-4 5 .4-6.7L2 15l4.7-3.5L4 6l5.8 2.1L12 2Z',
  mig:'M8 7V4h3v3h2V4h3v3h2v4l-2 2v7H8v-7l-2-2V7h2Zm2 6v5h4v-5h-4Z',
  dex:'M4 14c4-1 4-5 6-8l2 1-1 4 2-5 2 1-1 5 2-4 2 2-3 7c-1 3-4 5-7 4-3-1-5-3-4-6Z',
  ins:'M2 12s4-6 10-6 10 6 10 6-4 6-10 6S2 12 2 12Zm10-3a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z',
  wlp:'M12 21s-7-4.4-7-10a4 4 0 0 1 7-2.6A4 4 0 0 1 19 11c0 5.6-7 10-7 10Zm0-4 3-5h-2l1-4-5 6h2l-1 3h2Z',
  hp:'M12 21C5 17 3 13 3 9a4.5 4.5 0 0 1 8-2.8L12 8l1-1.8A4.5 4.5 0 0 1 21 9c0 4-2 8-9 12Zm-5-9h3l1-3 2 6 1-3h3',
  mp:'M12 2c1 5 6 7 6 12a6 6 0 0 1-12 0c0-4 3-7 6-12Zm0 7c-2 2-3 3.5-3 5a3 3 0 0 0 6 0c0-1.5-1-3-3-5Z',
  ip:'M12 2 4 8l3 12h10l3-12-8-6Zm0 4 4 3-2 7h-4L8 9l4-3Z',
  bonds:'M8.5 14.5 6 17a3.5 3.5 0 0 1-5-5l4-4a3.5 3.5 0 0 1 5 0l1 1-2 2-1-1a1 1 0 0 0-1.5 0l-4 4a1 1 0 0 0 1.5 1.5l2.5-2.5 2 1.5Zm7-5L18 7a3.5 3.5 0 0 1 5 5l-4 4a3.5 3.5 0 0 1-5 0l-1-1 2-2 1 1a1 1 0 0 0 1.5 0l4-4A1 1 0 0 0 20 8.5L17.5 11l-2-1.5ZM8 13l8-4 1 2-8 4-1-2Z',
  magic:'M12 2l1.6 5.4L19 6l-3 4.5 5 2.5-5 2.5L19 20l-5.4-1.4L12 24l-1.6-5.4L5 20l3-4.5L3 13l5-2.5L5 6l5.4 1.4L12 2Z',
  equipment:'M14 2 9 7l2 2-7 7-2 5 5-2 7-7 2 2 5-5-9-9Zm3 12 5 5-3 3-5-5 3-3Z',
  status:'M12 2 2 20h20L12 2Zm-1 6h2v6h-2V8Zm0 8h2v2h-2v-2Z',
